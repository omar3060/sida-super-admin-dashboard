              ...
              <form >
                ...
                <div className="row">
                  <div className="col-md-6 col-12 mb-2">
                    <div className="mb-3">
                      <label className="form-label">
                        Issued Date<span className="text-danger ms-1">*</span>
                      </label>
                      <div className="input-groupicon calender-input">
                        <Calendar className="info-img" />
                       
                        <DatePicker className="datetimepicker form-control p-2"
            ...
            <div className="modal-body">
              <div className="gift-card-header border p-3 rounded-1 bg-light">
                <div className="row row-gap-3">
                  ...
                  <div className="col-6 col-sm-4 col-md-3">
                    ...
                    <div className="userimgname d-flex align-items-center">
                      <span className="avatar avatar-sm">
                        ...
                        >
                          <img src="assets/img/users/user-33.png" alt="user" />
                        </Link>
                      </span>
                  ...
                  <div className="col-6 col-sm-4 col-md-3">
                    <p className="mb-0 fw-medium text-gray-9">Issued Date</p>
                    <p>24 Dec 2024</p>
                  </div>
                  <div className="col-6 col-sm-4 col-md-3">
                    <p className="mb-0 fw-medium text-gray-9">Expiry Date</p>
                    <p>24 Jan 2025</p>
                  </div>
                  <div className="col-6 col-sm-4 col-md-3">
