              ...
              <div className="modal-body p-4">
                <div className="drag-drop text-center mb-4">
                  <div className="upload">
                    <Link href="#">
                      <img src="assets/img/icons/drag-drop.svg" alt="image" />
                    </Link>
                    <p>
                      Drag and drop a <Link href="#">file to upload</Link>
                    </p>
                  </div>
                ...
                <ul>
                  <li className="d-flex align-items-center justify-content-between">
                    ...
                    <Link href="#" className="text-danger text-right">
                  ...
                  <li className="d-flex align-items-center justify-content-between">
                    <div className="d-flex align-items-center w-85">
                      ...
                      <div className="flex-fill">
                        <h6>
                          <Link href="#">Update work history.xls</Link>
                        </h6>
                        <span>616 MB</span>
                  ...
                  <li className="d-flex align-items-center justify-content-between">
                    <div className="d-flex align-items-center w-85">
                      ...
                      <div className="flex-fill">
                        <h6>
                          <Link href="#">Updated Project.zip</Link>
                        </h6>
                        <span>616 MB</span>
                        <div className="progress mt-2">
                          <div
              ...
              <div className="modal-body p-4">
                ...
                <ul>
                  ...
                  <li className="d-flex align-items-center justify-content-between">
                    ...
                    <div className="d-flex align-items-center">
                      <Link href="#" className="text-danger me-2">
                        <i data-feather="trash-2" className="feather-16" />
                      </Link>
