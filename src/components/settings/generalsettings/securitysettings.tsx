...
export default function SecuritySettingsComponent () {
    ...
    return (
        <div>
                                            ...
                                            <div className="d-flex align-items-center justify-content-between flex-wrap row-gap-3 border-bottom mb-3 pb-3">
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="fs-16">Verified Email : info@example.com</p>
                                                    </div>
                                                </div>
                                                <div className="d-flex align-items-center">
                                                    <span className="fs-20 text-success me-3">
                        ...
                        <div className="modal-body">
                            <div className="row">
                                ...
                                <div className="col-lg-12">
                                    <div className="input-blocks">
                                        <p className="fs-14">
                                            <i className="ti ti-info-circle me-1" /> New phone number only
            ...
            {/* /Change Email */}
            {/* Device Management */}
            <div className="modal device-management-modal fade" id="device-management">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="delete-header">
                                ...
                                <p className="fs-16">
                                    We are sorry to see you go! To help us improve, please let us know
