...
import {  List, Grid, Filter, Sliders, User, Edit2 } from "feather-icons-react";
...
export default function BankSettingComponent () {
              ...
              <div className="settings-wrapper d-flex">
                ...
                <div className="settings-page-wrap w-50">
                  ...
                  <div className="page-header bank-settings justify-content-end">
                    <Link
                      href={route.banksettingslist}
                      className="btn-list me-2 active"
                    >
                      <List className="feather-user" />
                    </Link>
                    <Link href={route.banksettingsgrid} className="btn-grid">
                            ...
                            <div className="card-body pb-0">
                              <div className="row">
                                ...
                                <div className="col-lg-3 col-sm-6 col-12 ms-auto">
                                  <div className="input-blocks">
                                    <Link href="#" className="btn btn-filters ms-auto">
                                      {" "}
                                      <i
                                        data-feather="search"
                                        className="feather-search"
