...
export default function PrefixesComponent () {
    return (
        <div>
                                            ...
                                            <div className="row">
                                                <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                                                    <div className="mb-3">
                                                        ...
                                                        <input type="text" className="form-control" defaultValue="SKU -" />
                                                    </div>
                                                </div>
                                                <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                                                    <div className="mb-3">
                                                        <label className="form-label">Supplier</label>
                                                        <input type="text" className="form-control" defaultValue="SUP -" />
                                                    </div>
                                                </div>
                                                <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                                                    <div className="mb-3">
                                                        <label className="form-label">Purchase</label>
                                                        <input type="text" className="form-control" defaultValue="PU -" />
                                                    </div>
                                                </div>
                                                <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                                                    <div className="mb-3">
                                                        <label className="form-label">Purchase Return</label>
                                                        <input type="text" className="form-control" defaultValue="PR -" />
                                                    </div>
                                                </div>
                                                <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                                                    <div className="mb-3">
                                                ...
                                                <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                                                    <div className="mb-3">
                                                        ...
                                                        <input type="text" className="form-control" defaultValue="SR -" />
                                                    </div>
                                                </div>
                                                <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                                                    <div className="mb-3">
                                                        <label className="form-label">Customer</label>
                                                        <input type="text" className="form-control" defaultValue="CT -" />
                                                    </div>
                                                </div>
                                                <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                                                    <div className="mb-3">
                                                        <label className="form-label">Expense</label>
                                                        <input type="text" className="form-control" defaultValue="EX -" />
                                                    </div>
                                                </div>
                                                <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                                                    <div className="mb-3">
                                                        <label className="form-label">Stock Transfer</label>
                                                        <input type="text" className="form-control" defaultValue="ST -" />
                                                    </div>
                                                </div>
                                                <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                                                    <div className="mb-3">
                                                ...
                                                <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                                                    <div className="mb-3">
                                                        ...
                                                        <input type="text" className="form-control" defaultValue="SO -" />
                                                    </div>
                                                </div>
                                                <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                                                    <div className="mb-3">
                                                        <label className="form-label">POS Invoice</label>
                                                        <input type="text" className="form-control" defaultValue="PINV -" />
                                                    </div>
                                                </div>
                                                <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                                                    <div className="mb-3">
                                                ...
                                                <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                                                    <div className="mb-3">
                                                        ...
                                                        <input type="text" className="form-control" defaultValue="TRN -" />
                                                    </div>
                                                </div>
                                                <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                                                    <div className="mb-3">
                                                        <label className="form-label">Employee</label>
                                                        <input type="text" className="form-control" defaultValue="EMP -" />
                                                    </div>
                                                </div>
                                            </div>
