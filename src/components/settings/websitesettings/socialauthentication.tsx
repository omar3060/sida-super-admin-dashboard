...
export default function SocialAuthenticationComponent  ()  {
                                                ...
                                                <div className="card">
                                                    <div className="card-body">
                                                        ...
                                                        <p className="border-bottom pb-3 mb-3">
                                                            Connect with friends, family and share updates, photos, moments
                                                ...
                                                <div className="card">
                                                    <div className="card-body">
                                                        <div className="d-flex align-items-center justify-content-between mb-2">
                                                            ...
                                                            <span className="badge bg-outline-light">Not connected</span>
                                                        </div>
                                                        <p className="border-bottom pb-3 mb-3">
                                            ...
                                            <div className="col-xl-6 col-lg-12 col-md-6 d-flex">
                                                <div className="card">
                                                    <div className="card-body">
                                                        ...
                                                        <p className="border-bottom pb-3 mb-3">
                                                            Network with people and professional organizations in your
                                                            industry.
                                                        </p>
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <div>
                                            ...
                                            <div className="col-xl-6 col-lg-12 col-md-6 d-flex">
                                                <div className="card">
                                                    <div className="card-body">
                                                        ...
                                                        <p className="border-bottom pb-3 mb-3">
                                                            Google has many special features to help you find exactly what
                                                            you are looking for.
                                                        </p>
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <div>
                                ...
                                <div className="content">
                                    ...
                                    <form >
                                        ...
                                        <div className="modal-footer">
                                            ...
                                            <Link href="#" className="btn btn-submit" data-bs-dismiss="modal">
                                                Submit
                                            </Link>
                                        </div>
                                    </form>
