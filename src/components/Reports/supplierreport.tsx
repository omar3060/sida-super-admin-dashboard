...
export default function  SupplierReportComponent() {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "Status",
      render: (text:any) => (
        <span className={`badge  ${text === 'Pending' ? 'badge-cyan' : text === 'Received' ? 'badge-success' : 'badge-warning'} d-inline-flex align-items-center badge-xs`}>
          {text}
        </span>
      ),
        ...
        <div className="table-tab">
          <ul className="nav nav-pills">
            <li className="nav-item">
              <Link className="nav-link active" href={route.supplierreport}>
                Supplier Report
              </Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" href={route.supplierduereport}>
                Supplier Due
              </Link>
            </li>
          </ul>
