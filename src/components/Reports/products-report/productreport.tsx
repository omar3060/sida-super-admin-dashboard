...
export default function  ProductreportComponent () {
    ...
    const columns = [
        ...
        },
        {
            ...
            sorter: (a:any, b:any) => a.Total_Ordered.length - b.Total_Ordered.length,
        },
        {
            title: "Revenue",
            dataIndex: "Revenue",
            sorter: (a:any, b:any) => a.Revenue.length - b.Revenue.length,
        },
                    ...
                    <div className="table-tab">
                        <ul className="nav nav-pills">
                            <li className="nav-item">
                                <Link className="nav-link active" href={route.productreport}>
                                    Product Report
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" href={route.productexpiredreport}>
                        ...
                        <div className="card table-list-card no-search">
                            <div className="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                                ...
                                <ul className="table-top-head">
                                    <TooltipIcons />
                                    <li>
                                        <Link href="#" data-bs-toggle="tooltip" data-bs-placement="top">
