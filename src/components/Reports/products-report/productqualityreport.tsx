...
export default function  ProductQualityreportComponent () {
    ...
    const columns = [
        ...
        },
        {
            ...
            sorter: (a:any, b:any) => a.Total_Quantity.length - b.Total_Quantity.length,
        },
        {
            title: "Alert Quantity",
            dataIndex: "Alert_Quantity",
            sorter: (a:any, b:any) => a.Alert_Quantity.length - b.Alert_Quantity.length,
        },
    ];
                ...
                <div className="content">
                    <div className="table-tab">
                        <ul className="nav nav-pills">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link active" href={route.productquantityreport}>
