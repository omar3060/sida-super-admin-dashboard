                ...
                <div className="content">
                    ...
                    <div className="row">
                        <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div className="card">
                                <img src="assets/img/img-01.jpg" className="card-img-top" alt="..." />
                        ...
                        <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div className="card">
                                ...
                                <div className="card-footer">
                                    <Link href="#" className="card-link text-danger m-1">
                                        Buy Now
                                    </Link>
                                    <Link
                                        href="#"
                        ...
                        <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div className="card">
                                <img src="assets/img/img-02.jpg" className="card-img-top" alt="..." />
                                <div className="card-body">
                                    <p className="card-text">
                        ...
                        <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div className="card">
                                <img src="assets/img/img-03.jpg" className="card-img-top" alt="..." />
                                <div className="card-body">
                                    <h6 className="card-title fw-semibold">Card title</h6>
                                    <p className="card-text">
                                    &apos; can be escaped with &apos;&rsquo;&apos;
                        ...
                        <div className="col-xl-3">
                            <div className="card text-center">
                                ...
                                <div className="card-body">
                                    ...
                                    <Link href="#" className="btn btn-primary mt-2 me-1">
                                        Read More
                                    </Link>
                                    <Link
                                        href="#"
                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-4">
                            <div className="card">
                                <img src="assets/img/img-05.jpg" className="card-img-top" alt="..." />
                                <div className="card-header">
                                    <div className="card-title">
                                    Image caps are widely used in Blog&apos;s
                                    </div>
                    ...
                    <div className="row">
                        <div className="col-xl-4">
                            <div className="card overlay-card">
                                <img src="assets/img/img-2.jpg" className="card-img" alt="..." />
                        ...
                        <div className="col-xl-4">
                            <div className="card overlay-card">
                                <img src="assets/img/img-3.jpg" className="card-img" alt="..." />
                        ...
                        <div className="col-xl-4">
                            <div className="card overlay-card">
                                <img src="assets/img/img-4.jpg" className="card-img" alt="..." />
                                <div className="card-img-overlay d-flex flex-column p-0">
                                    <div className="card-header">
                                        <div className="card-title text-fixed-white">
                                            Image Overlays Are Awesome!
                    ...
                    <div className="row">
                        <div className="col-xxl-3 col-xl-12">
                            <div className="card">
                                ...
                                <img src="assets/img/img-1.jpg" className="card-img-top" alt="..." />
                                <div className="card-body">
                        ...
                        <div className="col-xxl-3 col-xl-6">
                            <div className="card">
                                <Link href="#" className="card-anchor" />
                                <img src="assets/img/img-4.jpg" className="card-img-top" alt="..." />
                                <div className="card-body">
                                    <h6 className="card-title fw-semibold">
