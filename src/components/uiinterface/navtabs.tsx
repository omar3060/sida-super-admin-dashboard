                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <ul className="nav nav-tabs nav-tabs-top mb-3">
                                        ...
                                        <li className="nav-item">
                                            <Link className="nav-link" href="#top-tab2" data-bs-toggle="tab">
                                                Profile
                                            </Link>
                                        </li>
                                        <li className="nav-item">
                                            <Link className="nav-link" href="#top-tab3" data-bs-toggle="tab">
                                                Messages
                                            </Link>
                                        </li>
                                    </ul>
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <ul className="nav nav-tabs mb-3" role="tablist">
                                        ...
                                        <li className="nav-item">
                                            <Link href="#" className="nav-link disabled">Services</Link>
                                        </li>
                                    </ul>
                                    <div className="tab-content">
                                        <div
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <ul className="nav nav-pills mb-3" role="tablist">
                                        ...
                                        <li className="nav-item">
                                            <Link href="#" className="nav-link disabled">Offers</Link>
                                        </li>
                                    </ul>
                                    <div className="tab-content">
                                        <div
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    >
                                        ...
                                        <Link href="#" className="flex-sm-fill text-sm-center nav-link disabled">
                                            Services
                                        </Link>
                                    </nav>
