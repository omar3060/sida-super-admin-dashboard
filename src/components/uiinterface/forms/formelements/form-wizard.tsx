                ...
                <div className="tab-content" id="myTabContent">
                  ...
                  >
                    ...
                    <div className="d-flex mt-3">
                      <Link href="#" className="btn btn btn-primary next">Next</Link>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <div className="d-flex mt-3">
                      <Link href="#" className="btn btn btn-primary previous me-2">
                        {" "}
                        Back
                      </Link>
                      <Link href="#" className="btn btn btn-primary next">
                        Continue
                      </Link>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className="d-flex mt-3">
                      <Link href="#" className="btn btn-primary previous me-2">
                        Previous
                      </Link>
                      <Link href="#"
