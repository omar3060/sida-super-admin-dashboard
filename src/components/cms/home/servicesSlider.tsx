...
import {
  ...
  updateSlide,
  deleteSlide,
} from "../../../services/HomeService/servicesCarouselService";

const ServicesSliderManagement: React.FC = () => {
  const [servicesData, setServicesData] = useState<ParsedServicesSlider | null>(
    null
  );
  ...
  const [editingServices, setEditingServices] =
    useState<ParsedServicesSlider | null>(null);
  const [editingSlide, setEditingSlide] = useState<ServicesSlide | null>(null);
  ...
  const loadServicesData = async () => {
    try {
      setLoading(true);
      const data = await getServicesSlider();
  ...
  const handleSaveServices = async () => {
    ...
    try {
      ...
      await updateTitleContent(editingServices._id, editingServices.title);
      ...
      setError(
        err instanceof Error ? err.message : "Failed to save services data"
      );
    } finally {
      setLoading(false);
    }
  ...
  const handleEditSlideClick = (slide: ServicesSlide) => {
  ...
  const handleSaveSlide = async () => {
    ...
    try {
      ...
      const arabicData: ServicesLanguage = {
        title: slideFormData.titleArabic,
        content: slideFormData.contentArabic,
      };
      const englishData: ServicesLanguage = {
      ...
      if (isEditingSlide && editingSlide) {
        ...
        await addSlide(servicesData._id, selectedFile, arabicData, englishData);
      }
  ...
  const updateServicesField = (
    ...
    if (field === "title") {
      setEditingServices({
        ...editingServices,
        [field]: {
          ...editingServices[field as "title"],
          [language]: value,
        },
      });
    }
    ...
    <div className="page-wrapper">
      <div className="content">
        <div className="d-lg-flex align-items-center justify-content-between mb-4">
          <div>
            <h2 className="mb-1">Services Slider Management</h2>
            <p>Manage your website services slider content and images</p>
          </div>
            ...
            <div className="card-body">
              <div className="row">
                <div className="col-md-6">
                  ...
                  <p>
                    <strong>Title:</strong>{" "}
                    {servicesData.title.english || "No title set"}
                  </p>
                </div>
                <div className="col-md-6">
                  ...
                  <p>
                    ...
                    {servicesData.title.arabic || "لم يتم تعيين عنوان"}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="card-body">
            <div className="table-responsive">
              <table className="table table-hover">
                ...
                <tbody>
                  {servicesData && servicesData.slides.length > 0 ? (
                    servicesData.slides.map((slide) => (
                      <tr
                        key={slide._id}
      ...
      {showModal && editingServices && (
        <div className="modal fade show" style={{ display: "block" }}>
          <div className="modal-dialog modal-dialog-centered modal-lg">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">Edit Services Title</h5>
                <button
                  type="button"
                  className="btn-close"
                  ...
                  <div className="tab-pane active" id="english-content">
                    <div className="mb-3">
                      ...
                      <input
                        ...
                        value={editingServices.title?.english || ""}
                        onChange={(e) =>
                          updateServicesField(
                            "title",
                            e.target.value,
                  ...
                  <div className="tab-pane" id="arabic-content">
                    <div className="mb-3">
                      ...
                      <input
                        type="text"
                        className="form-control"
                        value={editingServices.title?.arabic || ""}
                        onChange={(e) =>
                          updateServicesField("title", e.target.value, "arabic")
                        }
                        dir="rtl"
                      />
                    </div>
...
export default ServicesSliderManagement;
